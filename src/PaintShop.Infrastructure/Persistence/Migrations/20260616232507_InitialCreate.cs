        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizeValue = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    SizeUnit = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false, defaultValue: "L"),
                    SellingPrice = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                    CostPrice = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                    LowStockThreshold = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false, defaultValue: 0m)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductVariantId = table.Column<int>(type: "int", nullable: false),
                    Location = table.Column<int>(type: "int", nullable: false),
                    QuantityChange = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockMovements_Sales_ReferenceSaleId",
                        column: x => x.ReferenceSaleId,
                        principalTable: "Sales",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_ProductVariantId_Location",
                table: "InventoryItems",
                columns: new[] { "ProductVariantId", "Location" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_ProductId_BaseType_SizeValue_SizeUnit",
                table: "ProductVariants",
                columns: new[] { "ProductId", "BaseType", "SizeValue", "SizeUnit" },
                unique: true,
                filter: "[BaseType] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_ReferenceSaleId",
                table: "StockMovements",
                column: "ReferenceSaleId");
